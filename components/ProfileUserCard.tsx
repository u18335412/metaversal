...
export const UserProfileCard: FC = () => {
  ...
  return (
    <Card className="overflow-hidden rounded-xl bg-background">
      <div className="h-16 bg-gradient-to-r from-[#ece9fb] to-[#fdede7]" />
      <CardContent className="flex gap-[1.625rem] p-6">
      ...
      <CardFooter className="flex flex-row justify-start gap-4 border-t bg-gradient-to-b from-white from-0% via-0% to-[#FFFAF5] px-6 pt-4">
...
const UserCardSkeleton = () => {
  return (
    <Card className="overflow-hidden rounded-xl bg-background">
      ...
      <CardFooter className="flex flex-row justify-start gap-4 border-t px-6 pt-4">
